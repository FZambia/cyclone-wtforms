...
from wtf.utils import BaseHandler
from wtf.utils import DatabaseMixin
from wtf.utils import TemplateFields
from wtf.forms import ExampleForm
...
class IndexHandler(BaseHandler):
    ...
    def get(self):
        ...
        data = {'hello': 'world', 'awesome': 'bacon', 'form': form}
